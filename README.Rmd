...
[![Codecov test coverage](https://codecov.io/gh/schochastics/signnet/branch/master/graph/badge.svg)]( https://app.codecov.io/gh/schochastics/signnet?branch=master)
<!-- badges: end -->
...
*(The figure below shows all 138 signed triads that can occur in a directed network)*
