...
This outlines how to propose a change to signnet. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("schochastics/signnet", fork = TRUE)`.
...
Code of
Conduct](https://schochastics.github.io/signnet/CODE_OF_CONDUCT.md). By
